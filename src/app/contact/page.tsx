    ...
    <div className="flex min-h-screen flex-col bg-gradient-to-tl from-black via-zinc-600/20 to-black">
      ...
      <main className="mt-56">
        <div className="mx-[8%] rounded-2xl">
          <div className="lg:grid-row-2 grid grid-cols-1 grid-rows-1 gap-y-4 lg:gap-y-16 gap-x-4 lg:grid-cols-2 font-mono place-items-center">
            <ContactCard
                title='Github'
                alt='Github SVG'
                svg={githubIcon}
        ...
        <div className='mt-20 mb-12 font-mono text-center mx-20'>
